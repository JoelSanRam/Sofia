		    ...
		    <nav>
		        ...
		        <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
	                ...
	                <li class="user_setting">
						<div class="dropdown">
	                		<a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><img class="rounded-circle" src="{{ asset('admin/images/team/e1.png')}}" alt="e1.png"> <span class="dn-1199">Ali Tufan</span></a>
										...
										<ul class="mb0">
											<li class="list-inline-item">
												<div class="portfolio_item">
													<img class="img-fluid" src="{{ asset('admin/images/property/fp1.jpg')}}" alt="fp1.jpg">
											...
											<li class="list-inline-item">
												<div class="portfolio_item">
													<img class="img-fluid" src="{{ asset('admin/images/property/fp2.jpg')}}" alt="fp2.jpg">
								    				<div class="edu_stats_list" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete"><a href="#"><span class="flaticon-garbage"></span></a></div>
												</div>
											</li>
											<li class="list-inline-item">
												<div class="portfolio_item">
													<img class="img-fluid" src="{{ asset('admin/images/property/fp3.jpg')}}" alt="fp3.jpg">
								    				<div class="edu_stats_list" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete"><a href="#"><span class="flaticon-garbage"></span></a></div>
												</div>
											</li>
										</ul>
...
<script type="text/javascript" src="{{ asset('admin/js/googlemaps1.js')}}"></script>
