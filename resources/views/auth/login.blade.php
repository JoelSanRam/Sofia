                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row">
                            <div class="col-md-12 login-form-header">
                               <p class="login-form-font-header text-center">SOFÍA <span>CONÁ</span><p>
                            </div>
                        </div>
...
<section style="height: 100vh;">
    ...
    <form method="post" action="">
        <div class="arkalogin">
            ...
            <input class="giris" type="text" name="kadi" placeholder="Usuario">
            <input class="giris" type="password" name="sifre" placeholder="•••••">
            <a href="#" target="blank"><input class="butonlogin" type="submit" name="" value="Ingresar"></a>
        </div>
    </form>
    </section><br>

    <span style="font-size: 17px; text-align: center; display: block; color: #fff;
    ">&copy; Sofía Coná 2020 – Desarrollado por  <a style="color: #000;" href="https://www.buho-solutions.com/">Búho Solutions</a></span>
    </div>
    </section>
